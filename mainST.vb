    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        While run = 1
            ...
            If CheckBox1.Checked Then
                ...
                Dim conn = 1
                While conn = 1
                    If ComboBox2.Text = "WR-840Nv4" Or ComboBox2.Text = "WR-849Nv4" Or ComboBox2.Text = "WR-849Nv5" Then
                        Dim oForm As Form1
                        oForm = New Form1()
                        oForm.ShowDialog()
                        conn = 0
                    ElseIf My.Computer.Network.Ping("192.168.00.01") Then
            ...
            If CheckBox2.Checked Then
                If CheckBox8.Checked And TextBox6.Text <> "" Then
                    ip = TextBox6.Text
                End If
                If ComboBox2.Text = "WR-845Nv4" Then
                    Dim first() As String = {"#!/bin/bash",
                                                   "uci commit network",
                                                   "rm /tmp/update.bin",
                    ...
                    Using outputFile As New StreamWriter(Convert.ToString("script.sh"))
                        For Each line As String In first
                            outputFile.WriteLine(line)
                        Next
                    End Using
                    Shell("cmd.exe /c echo yes | plink  -agent -pw " + passwd + " -m script.sh  root@" + ip + "", vbNormalFocus, True)
                End If
            ...
            Else
                ...
                Using outputFile As New StreamWriter(Convert.ToString("script.sh"))
                    ...
                    Next
                End Using
                Shell("cmd.exe /c echo yes | plink  -agent -pw " + passwd + " -m script.sh  root@" + ip + "", vbMinimizedFocus, True)
            End If
            ...
            If CheckBox6.Checked Then
                ...
                Using outputFile As New StreamWriter(Convert.ToString("script.sh"))
                    ...
                    Next
                End Using
                Shell("cmd.exe /c echo yes | plink  -agent -pw " + passwd + " -m script.sh  root@root@" + ip + "", vbMinimizedFocus, True)
            End If
            ...
            Using outputFile As New StreamWriter(Convert.ToString("script.sh"))
                ...
                Next
            End Using
            Shell("cmd.exe /c echo yes | plink  -agent -pw " + passwd + " -m script.sh  root@" + ip + "", vbHide, True)
            'Thread.Sleep(10000)'
            run = 0
        End While
